      ...
      <div  className='flex flex-col gap-y-8 lg:flex-row lg:items-center
       lg:gap-x-12'>
        ...
        <div className='flex-1 text-center font-secondary lg:text-left'>
          ...
          initial="hidden" 
          whileInView={'show'} 
          viewport={{once:false, amount:0.7}} className='text-[45px] 
          font-bold leading-[0.8] lg:text-[90px]'>
            MICHAEL <span>OKPALA</span>
          </motion.h1>
          ...
          viewport={{once:false, amount:0.7}}
           className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
            <a href='https://www.youtube.com/@trendymichael637/'>
              <FaYoutube />
            </a>
            <a href='#'>
              <FaDribbble />
            </a>
            <a href='https://github.com/codesbymichaelokpala/'>
              <FaGithub />
            </a>
          </motion.div>
